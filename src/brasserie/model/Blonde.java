...
public class Blonde extends Beer {
    public final String couleur = "Blonde";

    public Blonde(String nom, String type, double degree, double prix, List<String> ingredients){
